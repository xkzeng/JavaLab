...
public class BookController
{
	 ...
	 * 使用Thymeself作为模板视图工具:
	 */
	@RequestMapping(value = "/get_books", method = {RequestMethod.GET, RequestMethod.POST}, produces = {"application/json;charset=utf-8", "text/html;charset=utf-8", "text/plain;charset=utf-8"})
	 ...
	 * 使用JSP/JSTL作为模板视图工具:
	 */
	@RequestMapping(value = "/get_jsp_books", method = {RequestMethod.GET, RequestMethod.POST}, produces = {"application/json;charset=utf-8", "text/html;charset=utf-8", "text/plain;charset=utf-8"})
