...
public final class Message
{
  ...
  public void setNeedCallback(boolean needCallback)
	...
	public static Message obtain(MessageHandler h)
	{
		Message m = obtain();
		m._target = h;
		return m;
	...
	public static Message obtain(MessageHandler h, int what)
	{
		Message m = obtain();
		m._target = h;
		m._what = what;
	...
	public static Message obtain(MessageHandler h, int what, Object obj)
	{
		Message m = obtain();
		m._target = h;
		m._what = what;
	...
	public static Message obtain(MessageHandler h, int what, int arg1, int arg2)
	{
		Message m = obtain();
		m._target = h;
		m._what = what;
	...
	public static Message obtain(MessageHandler h, int what, int arg1, int arg2, Object obj)
	{
		Message m = obtain();
		m._target = h;
		m._what = what;
	...
	public static Message obtain(MessageHandler h, Runnable self)
	{
		Message m = obtain();
		m._target = h;
		m._self = self;
