...
public final class Message
{
	...
	/** Instance of MsgApp, message is sent by it */
	MsgApp _sender;
  ...
  public void setNeedCallback(boolean needCallback)
	...
	public static Message obtain(MsgApp sender)
	{
		Message m = obtain();
		m._sender = sender;
		return m;
	...
	public static Message obtain(MsgApp sender, int what)
	{
		Message m = obtain();
		m._sender = sender;
		m._what = what;
	...
	public static Message obtain(MsgApp sender, int what, Object obj)
	{
		Message m = obtain();
		m._sender = sender;
		m._what = what;
	...
	public static Message obtain(MsgApp sender, int what, int arg1, int arg2)
	{
		Message m = obtain();
		m._sender = sender;
		m._what = what;
	...
	public static Message obtain(MsgApp sender, int what, int arg1, int arg2, Object obj)
	{
		Message m = obtain();
		m._sender = sender;
		m._what = what;
	...
	public void setSender(MsgApp sender)
	{
		this._sender = sender;
	}
	
	public MsgApp getSender()
	{
		return this._sender;
	}
