...
public class BookController
{
	...
	public ModelAndView getBookList(HttpServletRequest request, HttpServletResponse response) throws IOException, SQLException
	{
		...
		mav.addObject("dbProductName", dbProductName);
		mav.addObject("dbDriverName", dbDriverName);
		mav.addObject("dbName", dbName);
		mav.addObject("dbURL", dbURL);
		mav.addObject("dbUserName", dbUserName);
	  ...
	  //选择映射器:获取映射器接口对象实例;
		...
		//返回数据库信息:
		mav.addObject("db_driver", bookList);
