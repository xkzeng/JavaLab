...
public final class Message
{
	...
	/** Instance of Runnable, message is handle by itself */
	Runnable _self;
	
	/** Instance of MessageHandler, message is sent by it */
	MessageHandler _sender;
	
	/** Instance of MessageHandler, message is received and handled by it */
	MessageHandler _target;
  ...
  public void setNeedCallback(boolean needCallback)
	...
	public static Message obtain(Message orig)
	{
		...
		m._target = orig._target;
		return m;
	}
	
	public static Message obtain(MessageHandler target)
	{
		Message m = obtain();
		m._target = target;
		return m;
	...
	public static Message obtain(MessageHandler target, int what)
	{
		Message m = obtain();
		m._target = target;
		m._what = what;
	...
	public static Message obtain(MessageHandler target, int what, Object obj)
	{
		Message m = obtain();
		m._target = target;
		m._what = what;
	...
	public static Message obtain(MessageHandler target, int what, int arg1, int arg2)
	{
		Message m = obtain();
		m._target = target;
		m._what = what;
	...
	public static Message obtain(MessageHandler target, int what, int arg1, int arg2, Object obj)
	{
		Message m = obtain();
		m._target = target;
		m._what = what;
	...
	public static Message obtain(MessageHandler target, Runnable self)
	{
		Message m = obtain();
		m._target = target;
		m._self = self;
	...
	public static Message obtain(MessageHandler target, MessageHandler sender)
	{
		Message m = obtain();
		m._target = target;
		m._sender = sender;
	...
	public static Message obtain(MessageHandler target, MessageHandler sender, int what)
	{
		Message m = obtain();
		m._target = target;
		m._sender = sender;
	...
	public static Message obtain(MessageHandler target, MessageHandler sender, int what, Object obj)
	{
		Message m = obtain();
		m._target = target;
		m._sender = sender;
	...
	public static Message obtain(MessageHandler target, MessageHandler sender, int what, int arg1, int arg2)
	{
		Message m = obtain();
		m._target = target;
		m._sender = sender;
	...
	public static Message obtain(MessageHandler target, MessageHandler sender, int what, int arg1, int arg2, Object obj)
	{
		Message m = obtain();
		m._target = target;
		m._sender = sender;
	...
	public static Message obtain(MessageHandler target, MessageHandler sender, Runnable self)
	{
		Message m = obtain();
		m._target = target;
		m._sender = sender;
	...
	public void setTarget(MessageHandler target)
	{
		this._target = target;
	}
	...
	public String toString()
	{
		...
		if(this._target != null)
		{
			...
			b.append(" target=");
			b.append(this._target.getClass().getName());
		}
		else
		{
			b.append(" barrier=");
