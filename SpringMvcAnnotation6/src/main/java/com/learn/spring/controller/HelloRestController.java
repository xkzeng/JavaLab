...
public class HelloRestController
{
	...
	public String getInfo()
	{
		...
		String msg = String.format(HTML_TEMPLATE, title, content, this.doAddBalance(10.00F));
		return msg;
	}
	...
	public String getInfo0()
	{
		...
		String msg = String.format(HTML_TEMPLATE, title, content, this.doAddBalance(100.00F));
		return msg;
	}
	...
	public String getInfo1(HttpServletRequest request, HttpServletResponse response) throws UnsupportedEncodingException
	{
		...
		String msg = String.format(HTML_TEMPLATE, title, content, this.doAddBalance(1000.00F));
		return msg;
	}
	...
	{
		String msg = String.format(HTML_TEMPLATE, title, content, this.doAddBalance(5000.00F));
		return msg;
	}
	...
	{
		String msg = String.format(HTML_TEMPLATE, title, content, this.doAddBalance(100000000.00F));
		return msg;
	}
	...
	{
		String msg = String.format(HTML_TEMPLATE, title, content, this.doAddBalance(200000000.58F));
		return msg;
	}
	...
	{
		String desc = "";
		if(balanceValue >= 100000000.00F && balanceValue < 200000000.00F)
			desc = "你发财了";
		else if(balanceValue >= 200000000.00F)
			desc = "你发大财了";
		else
			desc = "你发了点小财";
